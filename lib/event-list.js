    ...
    result.forEach(function(event){
      switch(event.eventType){
        ...
        case 'ChildWorkflowExecutionTimedOut':
          ...
          break;
        default:
          console.error('getChildWorkflowSummary unhandled eventAttributes.key "' + event.eventAttributes.key + '"');
    ...
    result.forEach(function(event){
      switch(event.eventType){
        ...
        case 'activityTaskCompletedEventAttributes':
          ...
          break;
        default:
          console.error('getActivityTaskSummary unhandled eventAttributes.key "' + event.eventAttributes.key + '"')
